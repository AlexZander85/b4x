...
func TestClassifyFourWayBehaviorOperatorSignals(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			r2:         BehaviorOutcomeFail,
			r3:         BehaviorOutcomeOK,
			r4:         BehaviorOutcomeOK,
			want:       "mutation-bypass-signal",
			conclusive: true,
		},
		{
			...
			r1:         BehaviorOutcomeOK,
			r2:         BehaviorOutcomeFail,
			r3:         BehaviorOutcomeFail,
			r4:         BehaviorOutcomeFail,
			want:       "mutation-breaks-control",
			conclusive: true,
		},
		{
			name:       "excludes target regression",
			r1:         BehaviorOutcomeOK,
			r2:         BehaviorOutcomeOK,
			r3:         BehaviorOutcomeOK,
			r4:         BehaviorOutcomeFail,
			want:       "mutation-target-regression",
			conclusive: true,
		},
		{
			name:       "unhealthy reference is inconclusive",
			r1:         BehaviorOutcomeFail,
			r2:         BehaviorOutcomeFail,
			r3:         BehaviorOutcomeOK,
			r4:         BehaviorOutcomeOK,
