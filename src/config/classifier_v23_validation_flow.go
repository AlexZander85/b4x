...
func (s classifierRuntimeValidation) validateFlowControls() {
	...
	s.defaultInt(&s.r.PassiveRST.RollbackWindowSeconds, s.d.PassiveRST.RollbackWindowSeconds)
	s.defaultInt(&s.r.PassiveRST.ReconnectFailureThreshold, s.d.PassiveRST.ReconnectFailureThreshold)
	s.defaultInt(&s.r.PassiveRST.NoProgressThreshold, s.d.PassiveRST.NoProgressThreshold)
	s.defaultInt(&s.r.PassiveRST.ControlFailureThreshold, s.d.PassiveRST.ControlFailureThreshold)
	s.defaultInt(&s.r.PassiveRST.QueueDropThreshold, s.d.PassiveRST.QueueDropThreshold)
	s.defaultInt(&s.r.PassiveRST.RouterPressureThreshold, s.d.PassiveRST.RouterPressureThreshold)
	...
	s.outOfRange("system.classifier.runtime.passive_rst.rollback_window_seconds", s.r.PassiveRST.RollbackWindowSeconds, 5, 3600)
	s.outOfRange("system.classifier.runtime.passive_rst.reconnect_failure_threshold", s.r.PassiveRST.ReconnectFailureThreshold, 1, 1024)
	s.outOfRange("system.classifier.runtime.passive_rst.no_progress_threshold", s.r.PassiveRST.NoProgressThreshold, 1, 1024)
	s.outOfRange("system.classifier.runtime.passive_rst.control_failure_threshold", s.r.PassiveRST.ControlFailureThreshold, 1, 1024)
	s.outOfRange("system.classifier.runtime.passive_rst.queue_drop_threshold", s.r.PassiveRST.QueueDropThreshold, 1, 1024)
