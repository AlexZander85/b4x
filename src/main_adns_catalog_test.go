...
func (catalogIDProvider) Capabilities() dnspath.DNSPathCapabilities { return dnspath.DNSPathCapabilities{State: dnspath.CapAvailable} }
func (p catalogIDProvider) Prepare(context.Context, dnspath.DNSPrepareRequest) (dnspath.PreparedDNSPath, error) { return dnspath.PreparedDNSPath{PathID:p.id}, nil }
func (catalogIDProvider) Probe(context.Context, dnspath.PreparedDNSPath, dnspath.DNSProbeQuery) (dnspath.DNSPathProbeOutcome, error) { return dnspath.DNSPathProbeOutcome{}, nil }
func (catalogIDProvider) Resolve(context.Context, dnspath.PreparedDNSPath, dnspath.DNSQuery) (dnspath.DNSResponse, error) { return dnspath.DNSResponse{}, nil }
func (catalogIDProvider) Health(context.Context, dnspath.PreparedDNSPath) dnspath.DNSPathHealth { return dnspath.DNSPathHealth{State:dnspath.CapAvailable} }
