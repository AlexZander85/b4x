...
const (
	...
	MetricClassifierReassembledSNI      = "classifier_reassembled_sni_total"
	MetricClassifierLayoutParityFail    = "classifier_layout_parity_fail_total"
	MetricNFQueueGSOPackets             = "nfqueue_gso_packets_total"
	MetricNFQueueGSOBytes               = "nfqueue_gso_bytes_total"
	MetricNFQueueGSOTruncated           = "nfqueue_gso_truncated_total"
	MetricNFQueueGSOCsumNotReady        = "nfqueue_gso_csum_not_ready_total"
	MetricNFQueueGSODecision            = "nfqueue_gso_decision_total"
	MetricNFQueueGSONormalized          = "nfqueue_gso_normalized_total"
	MetricNFQueueGSOActionSuppressed    = "nfqueue_gso_action_suppressed_total"
	MetricNFQueueGSOTokenMiss           = "nfqueue_gso_token_miss_total"
	MetricNFQueueGSOTransition          = "nfqueue_gso_transition_total"
	MetricPassiveRSTObserved            = "passive_rst_observed_total"
	MetricPassiveRSTDecision            = "passive_rst_decision_total"
	MetricPassiveRSTSuppressed          = "passive_rst_suppressed_total"
	MetricPassiveRSTFailOpen            = "passive_rst_fail_open_total"
	MetricPassiveRSTBaselineQuality     = "passive_rst_baseline_quality_total"
