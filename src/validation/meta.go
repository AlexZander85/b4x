...
//     constants (285 / 273 verified producers); deterministically sortable.
...
func RunMetaSuite(artifacts []Artifact) MetaResult {
	...
	// + 5 WARP nested dependency-graph producers (FB-03 §73B/§62.4:
	...
	r.Reproducible = HardGateCount() == 285 && len(ApplicableHardGates()) == 273 && len(hardGates) == 285
