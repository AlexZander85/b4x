...
| B4X-AUDIT-008 | 14 меж-документных противоречий (DDI-4 ownership; ADR-WARP 1..7 vs 1..6; GSOPassToken два определения; WARP_CAUSAL_TRACE_READY неидентичен в WARP vs IV; acceptance 86 vs 77; registry §23.1 устарел; цепочки → SP v1.5/ARCH v2.3; 16 KiB; gso_mode=classify; scoped-hints vs strict; zero-byte close формулировка) | findings_draft.md секция C |
