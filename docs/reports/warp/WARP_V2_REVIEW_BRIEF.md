...
**Дата компиляции:** 2026-08-23. Все номера строк/фактов соответствуют состоянию репо на эту дату.
**Материалы ревью:** (1) этот документ, (2) `.ag/research/warp-dataplane-design.md` — архитектура v2,
(3) код `src/transport/warp/` (+ контракты `src/warp/`), (4) по желанию — первоисточники ниже.
